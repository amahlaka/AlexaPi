...
class DirectiveDispatcher:
	...
	def processor(self, r):
		if r and r.status_code == 200:
			...
			for payload in msg.get_payload():
				if payload.get_content_type() == "application/json":
					...
					if shared.debug: print("\n{}->{}{}JSON String Received:{} {}".format(shared.bcolors.BOLD, shared.bcolors.ENDC, shared.bcolors.OKBLUE, shared.bcolors.ENDC, json.dumps(j)))
		...
		'''
			...
			player.play_avr(shared.resources_path+'error.mp3')
